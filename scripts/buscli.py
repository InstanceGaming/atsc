...
def get_cla():
    ...
    ap.add_argument('-H',
                    nargs='+',
                    dest='high',
                    help='Set these output indices high. Use "*" for all.')
    ap.add_argument('-L',
                    nargs='+',
                    dest='low',
                    help='Set these output indices low. Use "*" for all.')
    ap.add_argument('-T', '--transfer',
                    action='store_true',
                    dest='transfer',
                    help='Set FTR bit.')
...
def run():
    ...
    f = OutputStateFrame(DeviceAddress.TFIB1,
                         states,
                         transfer)
