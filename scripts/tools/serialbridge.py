#!/usr/bin/env python
#
# Redirect data from a TCP/IP connection to a serial _port and vice versa.
#
...
""")
    ...
    group.add_argument(
        '--rts',
        type=int,
        help='set initial RTS line _flasher (possible values: 0, 1)',
        default=None)

    group.add_argument(
        '--dtr',
        type=int,
        help='set initial DTR line _flasher (possible values: 0, 1)',
        default=None)
